...
import './register.css'
import {auth,provider} from "../../firebase/fiebase"
...
<label htmlFor="Lname" className='border-b text-gray-700 text-sm font-bold mb-2'>Last Name</label>
      ...
      <div className="login">
    {
        isDivVisible &&(
            ...
            <h5 id='state' className='mt-5 justify-center text-center'>
...
<span className='border-b- w-1/5 lg:w-1/4'></span>
 ...
 <div class="mt-4">
                 <label class=" block text-gray-700 text-sm font-bold mb-2 text-left">Email </label>
