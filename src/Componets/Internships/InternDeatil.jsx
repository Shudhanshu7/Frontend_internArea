...
useEffect(()=>{
  ...
  const response=await axios.get(`https://backend-internarea-dwep.onrender.com/api/internship/${id}`)
...
const text=document.getElementById("text")
  if (text.value==="") {
    ...
    await axios.post("https://backend-internarea-dwep.onrender.com/api/applications",bodyJson).then((res)=>{
